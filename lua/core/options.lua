...
-- Enable concealment for markdown so render-markdown.nvim can render headings, code blocks, etc.
...
local function apply_cursor_hl()
	vim.api.nvim_set_hl(0, "Cursor", { fg = "#000000", bg = "#ffffff", nocombine = true })
end
apply_cursor_hl()
vim.api.nvim_create_autocmd("ColorScheme", { callback = apply_cursor_hl })
vim.opt.guicursor = {
	"n-v-c:block-Cursor/lCursor",
	"i-ci-ve:block-blinkwait175-blinkoff150-blinkon175-Cursor/lCursor",
	"r-cr:hor20-Cursor3/lCursor3",
	"o:hor50-Cursor4/lCursor4",
}
